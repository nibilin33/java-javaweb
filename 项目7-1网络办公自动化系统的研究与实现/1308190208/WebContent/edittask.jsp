...
Dao dao=new Dao();
if(id!=null){
Task ta=dao.queryTaskByID(Integer.parseInt(id));
                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="card">
                            ...
                            <div class="content">
                                <form method="post" action="servlet/AddTask">
                                    <div class="row">
                   
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label>任务名：</label>
                                                <input type="text" class="form-control" placeholder="Taskname" name="taskName" value="<%=ta.getTaskName()%>">
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>时间：</label>
                                                <input type="text" class="form-control" placeholder="Time" name="getTime" value="<%=datestr%>">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>主题：</label>
                                                <input type="text" class="form-control" placeholder="Main theme" name="taskState">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                       <div class="col-md-12">
                                            <div class="form-group">
                                                <label>内容：</label>
                                               <textarea rows="5" class="form-control" placeholder="Here can be your description" name="taskInfo">
                                               <%=
                                               ta.getTaskInfo()
                                               %>
                                               </textarea>
                                            <input type="hidden" name="employeeName" value="<%=em.getEmployeeName()%>">
                                            </div>
                                        </div>
                                   ...
                                   &nbsp &nbsp   &nbsp &nbsp
                                     ...
                                     &nbsp &nbsp   &nbsp &nbsp    <a href="task.jsp" class="btn btn-info btn-fill">返回</a>
