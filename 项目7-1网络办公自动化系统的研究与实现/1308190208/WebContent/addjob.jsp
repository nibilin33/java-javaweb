...
<div class="wrapper">
    ...
    <div class="main-panel">
        ...
        <div class="card ">
                            <div class="header">
                            <h4 class="title"> <a href="editjob.jsp" class="btn btn-info btn-fill pull-right">返回</a> &nbsp &nbsp &nbsp</h4>
                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="card">
                            ...
                            <div class="content">
                                <form method="post" action="servlet/AddJob">
                                    <div class="row">
                                        <div class="col-md-5">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>职位描述</label>
                                                <input type="text" class="form-control" placeholder="Description" name="jobText">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
