                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="card">
                            ...
                            <div class="content">
                                <form method="post" action="servlet/AddEmployees"  >
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                <label>姓名：</label>
                                                <input type="text" class="form-control"  placeholder="username" name="employeeName">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>出生日期</label>
                                                <input type="text" class="form-control" placeholder="birthdate" name="birthday" >(例如：YYYY-YY-YY)
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>现在住址</label>
                                                <input type="text" class="form-control" placeholder="Home Adress" name="address">
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="card card-user">
                            ...
                            <div class="content">
                                <div class="author"  id="localImag" >
                                     <a href="#">
                                    <img class="avatar border-gray" id="preview" width=-1 height=-1 style="diplay:none" alt="..."/>
