                                ...
                                <form method="post" action="servlet/AddTask">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label>任务名：</label>
                                                <input type="text" class="form-control" placeholder="Taskname" name="taskName">
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                       <div class="col-md-12">
                                            <div class="form-group">
                                                <label>内容：</label>
                                               <textarea rows="5" class="form-control" placeholder="Here can be your description" name="taskInfo"></textarea>
