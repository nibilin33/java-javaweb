...
Dao dao=new Dao();
if(id!=null){
Employees em=dao.queryEmployeesByID(Integer.parseInt(id));
%>
<script> 
                                ...
                                <form method="post" action="servlet/AddEmployees">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                         <div class="form-group">
                                                <label>上传图像</label>
                                                <input  type="file" class="form-control" onchange="javascript:setImagePreview();" name="doc">
                                            </div>
                                            <div class="form-group">
                                               <label>就职协议</label> 
                             <textarea rows="10" cols="10" id="my_txt" name="agreement">
                             <%=em.getAgreement() %>
                             </textarea>
