...
%>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="card ">
                            <div class="header">
                                <h4 class="title">查看文件</h4>    
                            </div>
                            <div class="content">
                               <table class="table">
                           <tr>
                           <td>收件人</td>
                           <td><input type="text" name="fileTo" value="<%=s.getFileTo()%>"></td>
                           </tr>
                           <tr>
                            <td>主题</td>
                            <td><input name="fileName" value="<%=s.getFileName()%>">
                            </td>
                            </tr>
                           </table>
                             <div class="form-group">
                                                <label>邮件内容</label>
                                                 ...
                                                 <textarea rows="10" cols="10" id="my_txt" name="fileText" >
                                                 <%=s.getFileText()
                                                 %>
                                                 </textarea>
