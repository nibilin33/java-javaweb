<%@page import="official.entity.Employees"%>
                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="card">
                            ...
                            <div class="content">
                                <form method="post" action="servlet/ChangePsw" onsubmit="return check();">
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                <label>旧密码：</label>
                                                <input type="text" class="form-control"  placeholder="old password" name="old" value="<%=((Employees)session.getAttribute("emp")).getPwd()%>" >
                                                <input type="hidden" name="id" value="<%=session.getAttribute("id")%>">                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>新密码</label>
                                                <input type="text" class="form-control" placeholder="new password" name="psw" id="pas1">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>确认新密码</label>
                                                <input type="text" class="form-control" placeholder="confirem password" id="pas2">
                                            </div>
                                        </div>
                                    </div>
