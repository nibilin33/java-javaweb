                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="card">
                            ...
                            <div class="content">
                                <form method="post" action="servlet/AddDept">
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                <label>部门名称</label>
                                                <input type="text" class="form-control"  placeholder="Dept Name" name="deptName">
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>部门描述</label>
                                                <input type="text" class="form-control" placeholder="Dept Descript" name="deptText" >
                                            </div>
                                        </div>
