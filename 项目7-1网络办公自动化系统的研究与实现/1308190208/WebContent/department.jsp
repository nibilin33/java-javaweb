<%@ page language="java" import="java.util.*,java.text.*,official.dao.*,official.entity.*" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
    <jsp:useBean id="dept" class="official.entity.Dept" scope="session"></jsp:useBean>
...
<div class="wrapper">
   ...
   <div class="content">
                        ...
                        <div class="card">
                            ...
                            <div class="content table-responsive table-full-width">
                                <table class="table table-hover table-striped">
                                   ...
                                   List<Dept> de=dao.queryDeptByPage(currentPage);
                                   for (int i=0;i<de.size();i++){
                                    int s1=de.get(i).getDeptID();
                                       String s2= de.get(i).getDeptName();
                                       String s3=de.get(i).getDeptText();
                                   %>
     ...
     &nbsp &nbsp &nbsp  &nbsp &nbsp &nbsp  共有<%=totalpage%>页  &nbsp &nbsp &nbsp   当前第<%=currentPage%>页 &nbsp &nbsp &nbsp   <a href="department.jsp?page=1">第一页</a> &nbsp &nbsp &nbsp <a href="department.jsp?page=<%=currentPage-1%>">上一页</a>  &nbsp &nbsp &nbsp 
    
           <a href="department.jsp?page=<%=currentPage+1%>">下一页</a>
           &nbsp &nbsp &nbsp   <a href="department.jsp?page=<%=totalpage%>">最后一页</a>   
