                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="card">
                            ...
                            <div class="content">
                                <form method="post" action="servlet/AddNotice">
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>时间：</label>
                                                <input type="text" class="form-control" placeholder="Time" name="noteTime">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>主题：</label>
                                                <input type="text" class="form-control" placeholder="Main theme" name="noteName">
                                            </div>
                                        </div>
                                    </div>
