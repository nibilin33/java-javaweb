<%@ page language="java" import="java.util.*,java.text.*,official.dao.*,official.entity.*" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
    <jsp:useBean id="employee" class="official.entity.Employees" scope="session"/>
...
<form method="post" action="worker2.jsp">
                            ...
                            <div class="content table-responsive table-full-width">
                             <div class="header">
                                ...
                                <table class="table table-hover">
                                    ...
                                    int totalpage=dao.getTotaWorkPageByCondition(dep,user);
                                   ...
                                   de=dao.queryEmployByCondition(dep,user,currentPage);
                                    ...
                                    %>
                                        <tr>
                                        	...
                                        	<td><%=depar %></td>
                                        	 <td >
                                                    <a  href="person2.jsp?id=<%=id%>"tooltip" title="Edit Task" class="btn btn-info btn-simple btn-xs" >
                                                                                                                                                               编辑
                                                    </a>
 ...
 &nbsp &nbsp &nbsp  &nbsp &nbsp &nbsp  共有<%=totalpage%>页  &nbsp &nbsp &nbsp   当前第<%=currentPage%>页 &nbsp &nbsp &nbsp   <a href="worker2.jsp?page=1">第一页</a> &nbsp &nbsp &nbsp <a href="worker2.jsp?page=<%=currentPage-1%>">上一页</a>  &nbsp &nbsp &nbsp 
    
           <a href="worker2.jsp?page=<%=currentPage+1%>">下一页</a>
           &nbsp &nbsp &nbsp   <a href="worker2.jsp?page=<%=totalpage%>">最后一页</a>   
