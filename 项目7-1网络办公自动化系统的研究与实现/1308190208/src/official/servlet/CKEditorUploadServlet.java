...
public class CKEditorUploadServlet extends HttpServlet {  
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)  
        ...
        Date dNow = new Date();  
        // 设定上传文件路径  
//        String currentPath = "D:/developements/javaDevelopments/workspace-htz/office/WebContent"+baseDir  
//                + dirFormatter.format(dNow);
        ...
        if (enabled) {  
            ...
            try {  
                ...
                fileUrl = request.getContextPath()+ baseDir + "/" + fileName;  
                
                if (extIsAllowed(typeStr, ext)) {  
                    int counter = 1;  
                    while (pathToSave.exists()) {  
                        newName = nameWithoutExt + "_" + counter + "." + ext;  
                        fileUrl = request.getContextPath()+ baseDir + "/" + newName;  
