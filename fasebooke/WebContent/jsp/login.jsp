...
<div class="fb-container">
  <div class="fb_headcontainer">
   ...
   <div style="background-color:#e9ebee;padding:80px 0">
                          ...
                          <table>
                              <tbody>
                                ...
                                <span class="fa  fa-envelope-square" style="font-size:40px; color:blue;padding-right:4px"></span>
                                      ...
                                      <td>
                                         <input type="text" class="form-control" style="width:255px" id="zhaohui"> 
                                      </td>
                                  </tr>
                              </tbody>
                          </table>
    ...
    padding: 8px 10px;background-color:#e9ebee;padding-bottom:29px">
                   <div style="zoom:1">
                    <div style="float:right">
                          <button type="button" class="btn btn-default btn-info" onclick="zhaohuil(this)">搜索</button>
                      </div>
