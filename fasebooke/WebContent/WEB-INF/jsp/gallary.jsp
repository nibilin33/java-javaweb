...
<!--   container-->
 <div class="container">
    ...
    <div class="tab-pane fade in active" id="gay">
     <ul class="_mytakenpicture" id="my">
      <c:forEach items="${gaypic.pictures}" var="emp" varStatus="vs">
      <c:choose>
      <c:when test="${! empty emp.picname}">
      <li>
           <a href="javascript:;" data="${emp.pid}" onclick="deleteOnePig(this)"style="color:gray;position:relative;top:15px;text-decoration:none"><i class="glyphicon glyphicon-remove"></i></a> 
       <div class="pic2 fancybox img-responsive">
     
       <img src="${emp.picdescribe}" class="fancy" data-fancybox-group="gallery" title="${pic.ptime }">
   ...
   <c:otherwise>
      ...
      <div class="pic2">
       ...
       <img src="http://localhost:8080/img/face/photograph_102.20408163265px_1206043_easyicon.net.png">
      ...
      <input type="hidden" value="${gaypic.gpid}">
        </ul>
    </div>
