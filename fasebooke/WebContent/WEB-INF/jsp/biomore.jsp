             ...
             <div class="panel-body">
                 ...
                 <div class="col-ms-7">
                    <ul class="media-list" id="uldy">
                      <li class="media">
                        <h4 style="color:#90949c;border-bottom:1px solid #90949c">个人信息</h4>
                        <a class="pull-left" href="javascript:;" data="personal">
                        <div style="height:64px;width:64px;border:1px dashed #4080ff;">
                         ...
                         <div class="media-body">
                          <h4 class="media-heading" style="line-height:60px">详细介绍自己</h4>
                        </div>
                       
                        </li>
                        <li class="media">
                          <h4 style="color:#90949c;border-bottom:1px solid #90949c">喜爱的格言</h4>
                        <a class="pull-left" href="javascript:;" data="likeword">
                        <div style="height:64px;width:64px;border:1px dashed #4080ff;">
                            <i class="glyphicon glyphicon-plus" style="line-height:60px;margin-left:22px"></i>
                        </div>
                       </a>
                         <div class="media-body">
                          <h4 class="media-heading" style="line-height:60px">添加最爱的名言</h4>
                        </div>
...
$(document).ready(function() {
	  setCookie("fuid",'${current_user.fuid}');
    	setCookie("flikeword",'${current_user.flikeword}');
    	setCookie("fpersonal",'${current_user.fpersonal}');
