...
<!--   container-->
 <div class="container">
             ...
             <div class="panel-body" >
                 ...
                 <div class="col-ms-7"  >
                    ...
                    <ul class="media-list" id="uldy">
                      <li class="media">
                        <h4 style="color:#90949c;border-bottom:1px solid #90949c">工作</h4>
                        <a class="pull-left" href="javascript:;" data="uwork">
                        <div style="height:64px;width:64px;border:1px dashed #4080ff;">
                         ...
                         <div class="media-body">
                          <h4 class="media-heading" style="line-height:60px">添加工作场所</h4>
                        </div>
                       
                        </li>
                         <li class="media" >
                          <h4 style="color:#90949c;border-bottom:1px solid #90949c">大学</h4>
                        <a class="pull-left" href="javascript:;" data="Deducation">
                        <div style="height:64px;width:64px;border:1px dashed #4080ff;">
                            <i class="glyphicon glyphicon-plus" style="line-height:60px;margin-left:22px"></i>
                        </div>
                       </a>
                         <div class="media-body">
                          <h4 class="media-heading" style="line-height:60px">添加大学</h4>
                        </div>
                       
                        </li>
                        <li class="media">
                         <h4 style="color:#90949c;border-bottom:1px solid #90949c">高中</h4>
                        <a class="pull-left" href="javascript:;" data="Geducation">
                        <div style="height:64px;width:64px;border:1px dashed #4080ff;">
                            <i class="glyphicon glyphicon-plus" style="line-height:60px;margin-left:22px"></i>
                        </div>
                       </a>
                         ...
                         <div class="media-body">
                          <h4 class="media-heading" style="line-height:60px">添加高中</h4>
                        </div>
                       </li>
                     </ul>
             </div>
  ...
  <script type="text/javascript" src="<%=request.getContextPath()%>/resources/js/bootstrap.js"></script>
   ...
   <c:forEach items="${edu}" var="comment" varStatus="vs">
	<c:if test="${!empty comment.upro}">
	<script>
	setCookie("Duschool",'${comment.uschool}');
  	setCookie("Dutime",'${comment.utime}');
    setCookie("Dubstate",'${comment.ubstate}');
  	setCookie("Dudescription",'${comment.udescription}');
  	setCookie("Dupro",'${comment.upro}');
    setCookie("Duedid", '${comment.uedid}');
    setCookie("Durl", '${comment.url}');
	</script>
	</c:if>
	<c:if test="${empty comment.upro}">
	<script>
	setCookie("Guschool",'${comment.uschool}');
  	setCookie("Gutime",'${comment.utime}');
    setCookie("Gubstate",'${comment.ubstate}');
  	setCookie("Gudescription",'${comment.udescription}');
  	setCookie("Gupro",'${comment.upro}');
    setCookie("Guedid", '${comment.uedid}');
    setCookie("Gurl", '${comment.url}');
    </script>
	</c:if>
	</c:forEach>
	</c:when>	
...
$(document).ready(function() {
        setCookie("fuid",'${current_user.fuid}');
      	setCookie("uworkid",' ${work.uworkid}');
      	setCookie("ucompanyname",' ${work.ucompanyname}');
        setCookie("uzhiwei",' ${work.uzhiwei}');
      	setCookie("ulocation",' ${work.ulocation}');
      	setCookie("udescription",' ${work.udescription}');                     
