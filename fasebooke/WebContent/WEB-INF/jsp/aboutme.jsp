     ...
     <div class="row">
         <div class="panel panel-default">
             ...
             <c:choose>
                 ...
                 <c:otherwise>
                  <li class="media">
                        <a class="pull-left" href="http://localhost:8080/fasebooke/jian/${current_user.fuid}/education.action">
                  ...
                  <li class="media">
                        ...
                        <div style="height:64px;width:64px;border:1px dashed #4080ff;">
                         ...
                         <c:when test="${! empty current_user.fliveplace }">
                          <li class="media">
                        <a class="pull-left" href="javascript:;">
                        <img src="${current_user.fplace.lurl}" style="height:64px;width:64px;border:1px dashed #4080ff;">
                       </a>
                         <div class="media-body">
                          <h4 class="media-heading" style="line-height:60px">居住在${current_user.fliveplace}</h4>
                        </div>
                         ...
                         <c:otherwise>
                         <li class="media">
                        <a class="pull-left" href="http://localhost:8080/fasebooke/jian/${current_user.fuid}/liveing.action">
                        <div style="height:64px;width:64px;border:1px dashed #4080ff;">
                            <i class="glyphicon glyphicon-plus" style="line-height:60px;margin-left:22px"></i>
                        </div>
                       </a>
                        ...
                        <c:choose>
                         <c:when test="${!empty current_user.fhometown}">
                           <li class="media">
                        <a class="pull-left" href="javascript:;">
                        <img src="${current_user.fhome.lurl}" style="height:64px;width:64px;border:1px dashed #4080ff;">
                       </a>
                         <div class="media-body">
                          <h4 class="media-heading" style="line-height:60px">故乡在${current_user.fhometown}</h4>
                        </div>
                 ...
                 <c:if test="${! empty current_user.fsociallink}">
                  ...
                  <!--   <li class="media">
                    ...
                    <li class="media">
                       ...
                       <span>777777777</span> -->
                        <c:if test="${!empty current_user.flikeword }">
                       <li class="media">
                        <a class="pull-left" href="javascript:;">
                        <img src="http://localhost:8080/img/face/LIKE_100.09756097561px_1179710_easyicon.net.png" style="height:64px;width:64px;border:1px dashed #4080ff;">
                       </a>
                         <div class="media-body">
                        我喜欢的话：  <h4 class="media-heading" style="line-height:60px">${current_user.flikeword}</h4>
                        </div>
                       
                        </li> 
                       </c:if>
                         <c:if test="${!empty current_user.fpersonal }">
                       <li class="media">
                        <a class="pull-left" href="javascript:;">
                        <img src="http://localhost:8080/img/face/Text_Pirate_72px_1082461_easyicon.net.png" style="height:64px;width:64px;border:1px dashed #4080ff;">
                       </a>
                         <div class="media-body">
                        我的自描述：  <h4 class="media-heading" style="line-height:60px">${current_user.fpersonal}</h4>
                        </div>
